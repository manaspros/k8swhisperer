...
from src.mcp_server.kubectl_tools import get_events as _get_events
from src.mcp_server.kubectl_tools import get_nodes as _get_nodes
from src.mcp_server.kubectl_tools import get_pods as _get_pods
